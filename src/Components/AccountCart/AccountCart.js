...
export default function AccountCart({setRent}) {
  ...
  // Cart component
    return (
      ...
      <div className='h-screen lg:overflow-auto flex flex-col justify-between lg:w-96'>
        ...
        {/* TOTAL AREA  */}
        <div className="pb-40 bg-white px-4 py-4 lg:sticky lg:bottom-0 lg:right-0 max-lg:sticky max-lg:inset-x-0 max-lg:bottom-0">
        <PaymentForm 
