    ...
    return (
        <div>
            ...
            <div role="alert" id="missing-unit-banner" className="alert alert-warning hidden">
              ...
              {/* Warning header missing unit */}
              <div role="alert" id="missing-category-banner" className="alert alert-warning hidden">
                <svg
                    xmlns="http://www.w3.org/2000/svg"
                    className="h-6 w-6 shrink-0 stroke-current"
                    fill="none"
                ...
                <span>Warning: Select a category!</span>
            </div>
            ...
            <div role="alert" id="payment-success-banner" className="alert alert-success hidden">
             ...
             {/* Note succesful message */}
             <div role="alert" id="note-success-banner" className="alert alert-success hidden">
                <svg
                    xmlns="http://www.w3.org/2000/svg"
                    className="h-6 w-6 shrink-0 stroke-current"
                    fill="none"
            ...
            <div role="alert" id="error-banner" className="alert alert-error hidden">
             ...
             {/* Note error message*/}
             <div role="alert" id="error-note-banner" className="alert alert-error hidden">
                <svg
                    xmlns="http://www.w3.org/2000/svg"
                    className="h-6 w-6 shrink-0 stroke-current"
                    fill="none"
